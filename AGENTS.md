...
- Every code change **must be aligned with the requirements defined in `/docs`** (including PRD, DESIGN and PLAN files).
- Before implementing or modifying any feature, verify that it matches the documented product scope and priorities.
- If implementation deviates from `/docs`, you must:
...
> No code without docs alignment.
